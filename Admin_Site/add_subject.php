					...
					<div id="tab-1" class="tab">
						<article>
							<div class="text-section">
								<h1>Administrator</h1>
								<p>Add subject to the database.</p>
							</div>
							...
							<div class="text-section-black">
								<form method="post" name="catfrm" id="catfrm">
										<p>New Subject Details</p>
										<p>&nbsp;</p>
										<p>Subject Name &nbsp;: <input type="text" name="subname" id="subname" placeholder="Name" size="50" style=""/></p>
										<p>&nbsp;</p>
										<p>Subject Course : <input type="text" name="course" id="course" placeholder="Course" size="50" style=""/></p>
										<p>&nbsp;</p>
										<p>Description &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="desc" id="desc" placeholder="Description" size="50" style=""/></p>
										<p>&nbsp;</p>
...
<?php
	if(isset($_POST["savebtn"]))
	{
		...
		mysql_query("insert into subject (Subject_Name,Subject_Desc,Subject_Course,isDelete) values ('$name','$desc','$course',0)") or die(mysql_error());
