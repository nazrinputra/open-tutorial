					...
					<div id="tab-1" class="tab">
						<article>
							<div class="text-section">
								<h1>Administrator</h1>
								<p>Add category to the database.</p>
							</div>
							...
							<div class="text-section-black">
								<form method="post" name="catfrm" id="catfrm">
										<p>New Category Details</p>
										<p>&nbsp;</p>
										<p>Category Name : <input type="text" name="catname" id="catname" placeholder="Name" size="50" style=""/></p>
										<p>&nbsp;</p>
...
<?php
	if(isset($_POST["savebtn"]))
	{
		...
		mysql_query("insert into category (Category_Name,Category_Desc,isDelete) values ('$name','$desc',0)") or die(mysql_error());
