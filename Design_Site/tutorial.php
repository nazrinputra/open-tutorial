...
<div id="wrapper">
    ...
    <div class="content_box">
			<!-- EDIT HERE -->
            <h2>All Tutorials</h2>
			<em>Click on any tutorial title or view icon to view details and/or buy them.</em>
			<div class="result">
			<?php
			$result_tutorial=mysql_query("select * from tutorial where isActive=1 and isDelete=0 and Member_ID<>$sess_id");
							...
							<tr>
								...
								<td>
									<?php
										...
										?>
										<a href="uploader.php?mid=<?php echo $row_member["Member_ID"]; ?>">
										<?php echo $row_member["Member_Username"]; ?>
										</a>
								</td>
								<td>
									<?php
