...
<div id="wrapper">
    ...
    <div class="content_box">
			...
			<em>All previous purchases are listed here for reference. You can also generate a PDF report. Click on tutorial title to rate/review.</em>
			<div class="result">
			<?php
			$buy=mysql_query("select * from buy where Member_ID=$sess_id");
			$tids = "";
			...
			?>
					...
					while($row_tutorial=mysql_fetch_assoc($result_tutorial))
						{
							...
							<tr>
								<td>
									<a href="tutorial_details.php?tid=<?php echo $row_tutorial["Tutorial_ID"]; ?>"><?php echo $row_tutorial["Tutorial_Title"];$print=$print.$row_tutorial["Tutorial_Title"].";"; ?></a>
								</td>
								<td>
									<?php
				...
				<div class="update">
				<br><br>
				<p><a href="pdf.php" rel="external"><input type="button" name="pdf" style="margin-left:370px;" value="PDF Report"/></a></p>
				</div>
			<?php
			}
			else
