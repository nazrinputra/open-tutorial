...
<!--JQUERY LOGIN-->
			...
			<form id="loginfrm" action="" method="post">
				...
				<input type="submit" name="loginbtn" id="loginbtn" class="vpb_general_button" style="margin-left:170px;" value="Login"/>
				</div>
			</form>
