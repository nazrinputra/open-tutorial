...
<div id="wrapper">
    ...
    <div class="content_box">
			...
			<em>All announcement from admin is listed here for all users to view.</em>
			...
			<table class="dashboard_item" style="border-spacing:70px;margin-left:20px;">
				...
				<tr class="dashboard_item">
					<td style="background:#8FD8D8;">
						<em>Announcement from <u><?php echo $author_name ?></u></em>
						<br/><br/>
						<img src="../Admin_Site/images/<?php echo $author_pic; ?>" style="float:right;margin-right:40px;margin-top:-20px; width:100px;height:100px;"/>
				...
				<?php
					...
					{echo "<p>No announcement at this moment</p>";}
				?>	
			</div>
