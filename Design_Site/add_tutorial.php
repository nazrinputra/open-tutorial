			...
			<div class="detail_item">
				...
				<div class="element_item">
					...
					<form name="upload" method="" action="">
						...
						<p><a href="view_my_tutorial.php"><input type="button" value="Upload" name="uploadbtn"/></a></p>
					</form>
