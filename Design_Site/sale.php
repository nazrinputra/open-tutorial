...
<div id="wrapper">
    ...
    <div class="content_box">
		<h2>Items Uploaded by <?php echo $row_uploader["Member_Username"]; ?></h2>
			<?php
			$mid=$_REQUEST["mid"];
			...
			{echo "<p style='margin-left:40px;'>No tutorial uploaded by this member</p>";}
			?>
				<div style="margin-left:50px;">
				<br><br>
				<p><a href="tutorial_details.php?tid=<?php echo $_GET["tid"] ?>"><input type="button" name="back" value="Back"/></a></p>
				</div>
